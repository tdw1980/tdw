...
##        self.main_bg_img = os.path.join(images, 'SKINDEFAULT.jpg')
    ...
    def set_controls(self):
        ...
        self.no_int_label = xbmcgui.ControlLabel(1, 1, 1, 1, 'Диапазон:', alignment=ALIGN_CENTER)
        self.placeControl(self.no_int_label, 0, 0, 1, 5)
        
        self.no_int_label2 = xbmcgui.ControlLabel(1, 1, 1, 1, text, alignment=ALIGN_CENTER)
        ...
        # ControlSlider
        self.slider1 = xbmcgui.ControlSlider(1, 1, 1, 1, textureback=self.slider_bg, texture=self.slider_nib_nf, texturefocus=self.slider_nib)
        self.placeControl(self.slider1, 1, 0, 1, 5)
        self.slider1.setPercent(0)
        self.slider2 = xbmcgui.ControlSlider(1, 1, 1, 1, textureback=self.slider_bg, texture=self.slider_nib_nf, texturefocus=self.slider_nib)
    ...
    def onControl(self, control):
        ...
        if control == self.slider1:
            print 'slider1'
        n=self.slider1.getPercent()
        print n
        self.no_int_label2.setLabel(str(n))
