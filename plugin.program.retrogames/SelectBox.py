...
_ADDON_NAME = 'plugin.program.retrogames'
_addon = xbmcaddon.Addon(id=_ADDON_NAME)
_addon_path = _addon.getAddonInfo('path').decode(sys.getfilesystemencoding())
__settings__ = xbmcaddon.Addon(id='plugin.program.retrogames')
...
##        self.main_bg_img = os.path.join(images, 'SKINDEFAULT.jpg')
    ...
    def set_controls(self):
        ...
        self.placeControl(self.image3, 11, 22,6,9)

        no_int_label = xbmcgui.ControlLabel(1, 1, 1, 1, name, alignment=ALIGN_CENTER)
        self.placeControl(no_int_label, 14, 0, 2, 22)
        ...
        # ControlButton
        self.button2 = xbmcgui.ControlButton(1, 1, 1, 1, u'Сохранить', focusTexture=self.button_bg_focus,
                                                        noFocusTexture=self.button_bg_Nofocus, alignment=ALIGN_CENTER)
        self.placeControl(self.button2, 16, 0, 1, 7)
        self.button3 = xbmcgui.ControlButton(1, 1, 1, 1, u'Играть', focusTexture=self.button_bg_focus,
                                                        noFocusTexture=self.button_bg_Nofocus, alignment=ALIGN_CENTER)
        self.placeControl(self.button3, 16, 7, 1, 7)
        self.button = xbmcgui.ControlButton(1, 1, 1, 1, u'Отмена', focusTexture=self.button_bg_focus,
                                                        noFocusTexture=self.button_bg_Nofocus, alignment=ALIGN_CENTER)
        self.placeControl(self.button, 16, 14, 1, 7)
    ...
    def onControl(self, control):
        ...
        if control == self.button2:
            __settings__.setSetting(id=idw, value="save")
            self.close()
        if control == self.button3:
            __settings__.setSetting(id=idw, value="run")
            self.close()
